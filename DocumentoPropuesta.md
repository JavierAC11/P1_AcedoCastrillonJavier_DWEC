...
## Tecnologias
Las tecnologias que usaria para el proyecto seria para el frontend HTML junto a CSS y JavaScript con el uso del DOM y el framework de React, para el backend usaria Kotlin junto al framework de SpringBoot.
